...
public function jointureOuvre($id){
    $entityManager=$this->getEntityManager();
    $query=$entityManager
            ->createQuery('Select O FROM App\Entity\Oeuvre O 
            JOIN O.artiste A WHERE A.id=:id')
            ->setParameter('id',$id);
         return $query->getResult();
        }

public function nbrartis($id){
    $entityManager=$this->getEntityManager();
    $query=$entityManager
            ->createQuery('Select COUNT (O) FROM App\Entity\Oeuvre O 
            JOIN O.artiste A WHERE A.id=:id')
            ->setParameter('id',$id);
